      ...
      <div className="container text-left bg-grayE">
        <div className="flex items-center justify-between">
          <div className="flex-1" style={{ textAlign: 'left' }}>
            <h2 style={{ fontWeight: 'bold', fontSize: '44px', marginLeft: '65px' }}>MATCHING OUTFIT</h2>
            <p className="des-title" style={{ fontSize: '12px', fontWeight: '150', marginLeft: '65px' }}>
              Mang đến sự kết hợp tuyệt vời và đồng điệu.
            </p>
            <div className="home-button-container" style={{ marginLeft: '65px' }}>
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex-1" style={{ textAlign: 'left' }}>
            <h2 style={{ fontWeight: 'bold', fontSize: '44px', marginLeft: '65px' }}>
        ...
        <div className="flex items-center justify-between">
          <div className="flex-1" style={{ textAlign: 'left' }}>
            <h2 style={{ fontWeight: 'bold', fontSize: '44px', marginLeft: '65px' }}>POLO</h2>
            <p className="des-title" style={{ fontSize: '12px', fontWeight: '150', marginLeft: '65px' }}>
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex-1" style={{ textAlign: 'left' }}>
            <h2 style={{ fontWeight: 'bold', fontSize: '44px', marginLeft: '65px' }}>ACCESSORIES</h2>
            <p className="des-title" style={{ fontSize: '12px', fontWeight: '150', marginLeft: '65px' }}>
              Phụ kiện luôn là “vũ khí lợi hại” giúp trang phục trở nên thời thượng hơn.
            </p>
            <div className="home-button-container" style={{ marginLeft: '65px' }}>
              <HomeButton title="SHOP NOW" />
            </div>

                ...
                >
                  <div className="basis-[230px] max-w-[230px] text-left">
                    <h2 className="text-[0.8125rem] m-0 p-0 leading-[18px] font-bold uppercase">
                      <Link
                        href=""
                        className="text-[0.8125rem] m-0 p-0 leading-[18px] font-bold inline-block tracking-[0.03em] w-fit uppercase"
                      >
                        Áo thun
                      </Link>
                    </h2>
                  ...
                  <div className="basis-[230px] max-w-[230px] text-left">
                    <h2 className="text-[0.8125rem] m-0 p-0 leading-[18px] font-bold">
                      <Link
                        href=""
                        className="text-[0.8125rem] p-0 leading-[18px] font-bold inline-block tracking-[0.03em] m-0 w-fit uppercase"
                      >
                        Quần | Chân váy
                      </Link>
                    </h2>
